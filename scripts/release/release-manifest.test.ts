...
function certificationEvidence(targetRevision = revision): Record<string, unknown>[] {
  ...
  const desktop = (platform: "linux-x64" | "windows-x64", nativeName: string) => {
    ...
    moduleRuntime: {
      ...
      runtimeInputContentBytes: 8_000,
      runtimeInputFileCount: 80,
      runtimeInputSerializedBytes: 16_000,
      runtimeInputSha256: "9".repeat(64),
      runtimeExecutableSha256: platform === "windows-x64"
...
describe("release manifest", () => {
  ...
  test("Desktop receipt schema is exact and bound to official assets, activation and health", () => {
    ...
    const mutations: unknown[] = [
      ...
      { ...evidence, moduleRuntime: { ...moduleRuntime, candidateDefaultExportLinked: false } },
      { ...evidence, moduleRuntime: { ...moduleRuntime, candidateEvaluated: true } },
      { ...evidence, moduleRuntime: { ...moduleRuntime, moduleLinked: false } },
      ...
      { ...evidence, moduleRuntime: { ...moduleRuntime, runtimeExecutableSha256: "f".repeat(64) } },
      { ...evidence, moduleRuntime: { ...moduleRuntime, runtimeProductVersion: "1.18.20" } },
